...
train_mat_with_labels <- cbind(train_mat,as.vector(trainDataLabels))
...
test_mat_with_labels <- cbind(test_mat, as.vector(testDataLabels))
#print(head(train_mat_with_labels))
...
matrix_value = confusionMatrix(table(factor(predicted,levels=1:14),factor(testDataLabels,levels=1:14)))
matrix_value
```
