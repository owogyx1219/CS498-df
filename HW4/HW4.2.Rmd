...
```{r}
original_data = c(brush_teeth,climb_stairs,comb_hair,descend_stairs,drink_glass,eat_meat,eat_soup,getup_bed,liedown_bed,pour_water,sitdown_chair,standup_chair,use_telephone,walk)
```
...
for(i in 1:length(trainData))
{
  ...
  chunkSize <- floor( nrow(trainData[[i]]) / 50 )
  print(chunkSize)
...
cuttedData <- matrix(cuttedData, ncol = 150, byrow = TRUE)
#print(cuttedData)
#print(length(cuttedData))
#print(cuttedData[1:150])
...
```{r}
kmeans_14 = kmeans(cuttedData,centers = 14)
print(kmeans_14)
