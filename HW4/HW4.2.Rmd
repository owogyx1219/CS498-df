...
print(cluster_vec[1])
activity_summary_1 <- rep(0, 14)
activity_summary_2 <- rep(0, 14)
activity_summary_3 <- rep(0, 14)
activity_summary_4 <- rep(0, 14)
activity_summary_5 <- rep(0, 14)
activity_summary_6 <- rep(0, 14)
activity_summary_7 <- rep(0, 14)
activity_summary_8 <- rep(0, 14)
activity_summary_9 <- rep(0, 14)
activity_summary_10 <- rep(0, 14)
activity_summary_11 <- rep(0, 14)
activity_summary_12 <- rep(0, 14)
activity_summary_13 <- rep(0, 14)
activity_summary_14 <- rep(0, 14)
...
for(index in 1:length(cluster_vec))
{
  ...
  if(index <= 3)
  {
    print(paste("activity_summary_",activity_index , sep = ""))
  }
