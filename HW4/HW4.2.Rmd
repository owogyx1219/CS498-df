...
train_labels <- getLabels(trainData, trainSize)
...
test_labels <- getLabels(testData, testSize)
...
#print(head(test_mat_with_labels))

colnames(train_mat_with_labels) <- c("1thcol","2thcol", "3thcol", "4thcol", "5thcol", "6thcol", "7thcol", "8thcol", "9thcol", "10thcol", "11thcol", "12thcol", "13thcol", "14thcol", "label_name")

#print(train_mat_with_labels)
train_data_df <- data.frame(train_mat_with_labels)
print(train_data_df)
#fit = randomForest(train_mat_with_labels$label_name ~., data = train_mat_with_labels)
#prediction = predict(fit,test_mat_with_labels, predict.all = TRUE)
