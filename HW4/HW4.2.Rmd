...
```{r}
retResults <- vecQuantization(trainData, trainSize)
train_hist <- retResults[[1]]
train_labels <- retResults[[2]]
print(typeof(train_hist))
print(head(train_labels))
train_hist <- cbind(data.frame(train_hist),train_labels)
print(head(train_hist))
print(train_hist)
